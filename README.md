...
1. 到 [Releases](https://github.com/MisiteQ/QYRead/releases) 按 NAS 架构下载：`qyread-0.1.14-x86.fpk`（x86 机型）或 `qyread-0.1.14-arm.fpk`（arm64 机型）
...
.\build.ps1                 # 自动 patch +1（0.1.13 → 0.1.14），同步 manifest / package.json / 前端 ?v=
